...
public interface LedgerCategoryBudgetRepository extends JpaRepository<LedgerCategoryBudgetEntity, String> {
    ...
    @Query("SELECT MAX(e.updatedAt) FROM LedgerCategoryBudgetEntity e WHERE e.libraryId = :libraryId")
    ...
    @Modifying
    @Query("UPDATE LedgerCategoryBudgetEntity e SET e.deletedAtMillis = :deletedAtMillis, e.updatedAt = :updatedAt " +
