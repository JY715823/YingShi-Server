...
public interface LedgerCategoryRepository extends JpaRepository<LedgerCategoryEntity, String> {
    ...
    @Query("SELECT MAX(e.updatedAt) FROM LedgerCategoryEntity e WHERE e.libraryId = :libraryId")
    ...
    @Modifying
    @Query("UPDATE LedgerCategoryEntity e SET e.deletedAtMillis = :deletedAtMillis, e.updatedAt = :updatedAt " +
