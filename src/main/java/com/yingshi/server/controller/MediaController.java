...
public class MediaController {
    ...
    public ApiResponse<List<MediaImportStatusDto>> getImportStatus(
            @Valid @RequestBody MediaImportStatusRequest body,
            @CurrentUser AuthenticatedUser currentUser,
            HttpServletRequest request
    ) {
        return ApiResponse.success(requestId(request), mediaService.getImportStatus(currentUser, body.sourceFingerprints()));
    }
